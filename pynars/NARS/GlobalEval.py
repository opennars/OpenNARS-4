"""
This file implement the four global evaluations mentioned in [the design report of OpenNARS 3.1.0](https://cis.temple.edu/tagit/publications/PAGI-TR-11.pdf)
...
class GlobalEval:
    ...
    def update_alertness(self, w, p):
        ''''''
        r = GlobalEval.r * p
        self.W = r*w + (1-r)*self.W

    def update_busyness(self, b, p):
        ''''''
        r = GlobalEval.r * p
        self.B = r*b + (1-r)*self.B

    def update_wellbeing(self, w, p):
        ''''''
        r = GlobalEval.r * p
        self.W = r*w + (1-r)*self.W
