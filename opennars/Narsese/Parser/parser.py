from opennars.Narsese import Term, Judgement, Tense, Statement, Copula, Truth, Stamp, Interval
from opennars.Narsese import Base, Operator, Budget, Task, Goal, Punctuation, Question, Quest, Sentence, VarPrefix, Variable, Connector, Compound, SELF
