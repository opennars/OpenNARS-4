...
import functools
import re
from opennars.Interface import narsese_parse_safe
from opennars.Narsese import Term,Task
from opennars.NARS.DataStructures import Memory

from opennars.Interface import NARSInterface,NARSOutput,PrintType,Reasoner,print_out_origin
...
def operator_list(*keywords: List[str]) -> None:
    ...
    from opennars.NARS.Operation.Register import registered_operators, get_registered_operator_by_name, registered_operator_names
