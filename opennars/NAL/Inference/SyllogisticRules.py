...
from opennars.NAL.Functions.BudgetFunctions import Budget_backward_weak, Budget_forward, Budget_inference, Budget_backward
from opennars.Narsese import Term, Copula, Statement, Truth, Task, Belief, Budget, Stamp
