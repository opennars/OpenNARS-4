...
from opennars.Narsese import Copula, Statement, Compound, Connector, Term, Task, Budget, Stamp
...
from opennars.Narsese import Judgement, Truth, Goal, Quest, Question
