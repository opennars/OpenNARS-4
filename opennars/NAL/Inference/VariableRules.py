import math
from opennars.NAL.Functions.DesireValueFunctions import Desire_strong, Desire_weak, Desire_deduction, Desire_induction
from opennars.NAL.Functions.TruthValueFunctions import *
from opennars.NAL.Functions.BudgetFunctions import Budget_backward_weak, Budget_forward, Budget_inference, Budget_backward, Budget_forward_compound
from opennars.Narsese import Term, Copula, Statement, Truth, Task, Belief, Budget, Stamp, VarPrefix, Compound
from opennars.Narsese import Punctuation, Sentence, Judgement, Goal, Question, Quest
from ..Functions import F_deduction, fc_to_w_minus, fc_to_w_plus
from copy import deepcopy
from ..Functions.StampFunctions import *
from opennars.NAL.MetaLevelInference.VariableSubstitution.Introduction import Introduction, get_introduction__const_var
from opennars.NAL.MetaLevelInference.VariableSubstitution.Elimination import Elimination, get_elimination__var_const
'''
Introducton Rules:
