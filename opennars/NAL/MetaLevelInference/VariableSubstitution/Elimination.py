...
from opennars.Narsese import Term, Statement, Compound, VarPrefix, Variable
from opennars.utils.IndexVar import IntVar

from .Substitution import Substitution
from opennars.utils.tools import find_pos_with_pos, find_var_with_pos, find_pos_with_var
