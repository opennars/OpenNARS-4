from opennars.Narsese import Task, parser
from opennars.NAL.Inference.LocalRules import revision
from opennars.NARS.DataStructures.MC import InputBufferMC
