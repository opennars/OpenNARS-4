...
from opennars.NAL.Functions import Or
from opennars.NAL.Functions.Tools import calculate_solution_quality, distribute_budget_among_links
from opennars.NAL.Functions.BudgetFunctions import Budget_merge
from opennars.Narsese import Belief, Task, Item, Budget, Sentence, Term, Task, Judgement, Goal
from opennars.Narsese._py.Sentence import Quest, Question
...
class Concept(Item):
    ...
    def match_belief(self, sentence: Union[Judgement, Question, Goal]) -> 'Belief | None':
        '''
