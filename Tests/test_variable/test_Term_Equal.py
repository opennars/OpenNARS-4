...
class TEST_Term_Equal(unittest.TestCase):
    ...
    def test_term_equal_1(self):
        term1 = Term("bird")
        term2 = Term("animal")
        self.assertFalse(term1.equal(term2)[0])
        pass
    ...
    def test_mix_equal_0(self):
        ...
        self.assertFalse(term1.equal(term2)[0])
        self.assertFalse(term2.equal(term1)[0])
        pass
    ...
    def test_mix_equal_3(self):
        ...
        self.assertFalse(term1.subject.equal(term2)[0])
        self.assertFalse(term2.equal(term1.subject)[0])
        pass
    ...
    def test_statement_equal_2(self):
        ...
        self.assertTrue(term1.equal(term2)[0])
        self.assertTrue(term2.equal(term1)[0])
        pass
