    ...
    def generate_narsese_input(self, t):
        if t % 3 == 1:
            return [parser.parse("$" + str(0.5 + random.random() * 0.4) + ";" + str(
                ...
                0.5 + random.random() * 0.4) + "$ " + "<(*,[Channel_1], A) --> ^see>" + ". :|: %" + str(
                0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + "% \n")]
        elif t % 3 == 0:
            return [parser.parse("$" + str(0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + "$ " + "<(*,[Channel_1], B) --> ^see>" + ". :|: %" + str(
                0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + "% \n")]
...
class Channel2(SensoryMotorChannel):
    ...
    def generate_narsese_input(self, t):
        if t % 3 == 1:
            return [parser.parse("$" + str(0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + "$ " + "<(*,[Channel_2], a) --> ^see>" + ". :|: %" + str(
                0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + "% \n")]
        elif t % 3 == 0:
            return [parser.parse("$" + str(0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + "$ " + "<(*,[Channel_2], b) --> ^see>" + ". :|: %" + str(
                0.5 + random.random() * 0.4) + ";" + str(
                0.5 + random.random() * 0.4) + "% \n")]
...
class Reasoner:
    ...
    def concept_attention_visualization(self, t):
        ...
        plt.figure()
        plt.imshow(img)
        plt.savefig("C:\\Users\\TORY\\OneDrive - Temple University\\AGI research\\NARS_Optimizer\\img\\"+str(t)+".jpg")
