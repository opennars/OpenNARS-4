...
'''
import math
from NAL.Functions.DesireValueFunctions import Desire_strong, Desire_weak, Desire_deduction, Desire_induction
from NAL.Functions.TruthValueFunctions import *
from NAL.Functions.BudgetFunctions import Budget_backward_weak, Budget_forward, Budget_inference, Budget_backward
from Narsese import Term, Copula, Statement, Truth, Task, Belief, Budget, Stamp
from Narsese import Punctuation, Sentence, Judgement, Goal, Question, Quest
